...
def mount_userspace():
    os.system("nohup bash /ylstackos/files/userspace/start.sh >> /ylstackos/logs/userspace_start.log 2>&1 &")
def umount_userspace():
   os.system("nohup bash /ylstackos/files/userspace/stop.sh >> /ylstackos/logs/userspace_stop.log 2>&1 &")
