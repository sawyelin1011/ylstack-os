...
# Dashboard configuration backup file
# Original FlyOS config by DigitalPlat Team (Edward Hsing) — adapted for YL StackOS
...
show_motd = True   # Display device information on YL StackOS bash login
...
# Userspace config
userspace_vnc_login_user = 'ylstackos' # Default: user 'ylstackos' in userspace
userspace_ttyd = True


# Boot configuration (services on YL StackOS boot)
boot_userspace = True
